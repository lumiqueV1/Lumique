...
ROOT_URLCONF = 'Beautyswipe.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [ BASE_DIR, 'Beautyswipe_v1', 'templates' ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'Beautyswipe.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'bFe2fD-fg6f*F536c2D25F215E2A3CeF',
